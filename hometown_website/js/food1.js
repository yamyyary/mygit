	...
	i.prototype={
		...
		animate:function(t){
			...
			function(){
				...
				t<0&&o<-e*(s-2)&&n.css("left",-e),t>0&&o>-e&&n.css("left",-e*(s-2)),
				i.index=n.position().left/-e-1,i.opts.buttons&&i.showBtn()
			})
		},
		showBtn:function(){
		...
		eventBind:function(){
			var i=this,n=this.ele.find(".carousel-prev-btn"),e=this.ele.find(".carousel-next-btn"),s=this.ele.find(".carousel-indicators"),o=this.ele.width(),
